...
module.exports = function(app) {
  ...
  app.get('/REST/indicateurs', indicateurs.findAll);
  app.get('/REST/indicateurs/:id', indicateurs.findById);
  ...
  app.get('/REST/taches', taches.findAll);
  app.get('/REST/taches/:id', taches.findById);
